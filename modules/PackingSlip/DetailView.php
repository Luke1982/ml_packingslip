...
if(isPermitted("PackingSlip","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

$smarty->assign("CREATEPDF","permitted");

if(isPermitted("PackingSlip","Delete",$_REQUEST['record']) == 'yes')
	$smarty->assign("DELETE","permitted");

//Get the associated Products and then display above Terms and Conditions
$smarty->assign("ASSOCIATED_PRODUCTS",get_packingslip_detail_assoc_products('PackingSlip',$focus));
...
{
	global $log;
	$log->debug("Entering get_packingslip_detail_assoc_products(".$module.",".get_class($focus).") method ...");
	global $adb;
	global $mod_strings;
	global $theme;
	global $log;
	...
	//Get the taxtype of this entity
  	$taxtype = get_packingslip_inventory_taxtype($focus->id);

	$currencytype = get_packingslip_inventory_currency_info($focus->id);
	...
	$log->debug("Exiting get_packingslip_detail_assoc_products function ...");
	return $output;
}
